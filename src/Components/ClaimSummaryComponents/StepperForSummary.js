...
const StepperComponentSummary = (props) => {
    const { theme } = props
    return (
                ...
                <View style={styles.stepperLinks}>
                    ...
                    <View style={{ flex: 1 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: "center", marginRight: scale(22) }}>
                            <View style={[styles.blackLine, { backgroundColor: theme.color }]}>
                            </View>
                            <View>
                                <View style={[styles.darkCircle, { backgroundColor: theme.color }]}></View>
                            </View>

                        </View>
                        <Text style={[styles.stepperText, { textAlign: "right", opacity: scale(0.3), color: theme.color }]}>Confirmation</Text>
                    </View>
                </View>
            </View>
        </View>
...
export default StepperComponentSummary;
